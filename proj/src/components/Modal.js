...
const Modal = () => {
  ...
  return(
      <Background>
        <Content>
          <ContentInfo>
            <div class="previewModal-close" align="right" margin-top="80px">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="Hawkins-Icon Hawkins-Icon-Standard" data-uia="previewModal-closebtn" role="button" aria-label="close" tabindex="0">
            ...
            <ButtonLeft>
                <button aria-label="내가 찜한 콘텐츠에서 삭제" class="color-supplementary hasIcon round ltr-uhap25" data-uia="add-to-my-list-added" type="button">
                    <div class="small ltr-1evcx25" role="presentation">
